...
namespace Assets.Reusable
{
    ...
    public abstract class AStarAlgorithm<T>
    {
        ...
        protected internal Dictionary<T, T> cameFrom = new Dictionary<T, T>();
        protected internal Dictionary<T, float> gScore = new Dictionary<T, float>();
        protected internal Dictionary<T, float> fScore = new Dictionary<T, float>();
        ...
        public List<T> CalculatePath(T start, T goal)
        {
            ...
            {
                lastIterationCount++;
                if (lastIterationCount > MaxIterations)
                {
                    return null;
                }
