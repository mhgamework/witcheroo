...
namespace MHGameWork.TheWizards
{
    ...
    public static class UtilityExtensions
    {
        ...
        public static Point3 ToXZ(this Point2 v)
        {
            return v.ToXZ(0);
        }
        public static Point3 ToXZ(this Point2 v, int y)
        {
            return new Point3(v.X, y, v.Y);
        }
        public static Point2 TakeXZ(this Point3 v)
        {
            return new Point2(v.X, v.Z);
        }
        public static Point2 TakeXY(this Point3 v)
        {
        ...
        public static Point2 ToFloored(this Vector2 v)
        {
            return new Point2(((int)Mathf.Floor(v.x)), ((int)Mathf.Floor(v.y)));
        }
        public static Point2 ToCeiled(this Vector2 v)
        {
            return new Point2(((int)Mathf.Ceil(v.x)), ((int)Mathf.Ceil(v.y)));
        }
        public static Point2 ToRounded(this Vector2 v)
        {
            return new Point2(((int)Mathf.Round(v.x)), ((int)Mathf.Round(v.y)));
        }
