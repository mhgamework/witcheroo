...
namespace Assets.UnityAdditions
{
    static public class MethodExtensionForMonoBehaviourTransform
    {
        ...
        static public T GetRequiredComponent<T>(this Component child) where T : Component
        {
            var ret = child.GetComponent<T>();
            if (ret == null)
                throw new Exception($"Cannot find required component of type {typeof(T).Name} for {child}");
            return ret;
        }
        /// <summary>
